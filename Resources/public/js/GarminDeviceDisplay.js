...
//         	this.clearActivityQueue();  // Clearing does not work for whatever reason... timing/async
  ...
  _generateFindDevicesElement   : function () {
    ...
    this.browseComputerButton = new Element(this.options.useLinks ? "div" : "input", {
      id: this.options.browseComputerButtonId, className: this.options.browseComputerButtonClass
    });
    ...
    this.uploadNewButton.onclick = function () {
      ...
      if (isSupportedDevice) {
        if (this.options.autoHideUnusedElements) {
          ...
          this.browseComputerButton.hide();
          this.uploadProgressBar.hide();
          if (this.changeDeviceElement != null) {
            this.changeDeviceElement.hide();
          }
          if (this.connectedDevices != null) {
            this.connectedDevices.hide();
          }
          if (this.deviceSelectInput != null) {
  ...
  _addToActivityTableHeader: function (directory) {
    ...
    if (this.options.uploadMaximum < 1) {
      ...
      this.checkAllBox.onclick = function () {
        this._checkNewDirectoryEntries();
      }.bind(this);
    }
  },
...
/** @lends Garmin.DeviceDisplayDefaultOptions */
{
  ...
  getActivityDirectoryHeaderIdLabel: function () {
    return this.fileTypeRead == Garmin.DeviceControl.FILE_TYPES.readableDir ? "<b>File</b>" : "<b>Date</b>";
  },
...
var GarminDeviceDisplay = {
  ...
  load: function () {
    ...
    $A(document.getElementsByTagName("script"))
      ...
      .each(
      function (s) {
        s.src = 'http://developer.garmin.com/web/communicator-api/garmin/device/GarminDeviceDisplay.js';
